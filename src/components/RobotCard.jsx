...
const RobotCard = ({ robot }) => {
  ...
  return (
    <div className="max-w-sm w-full h-[600px] flex flex-col bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
      <img
      ...
      <div className="p-5 flex flex-col justify-between flex-grow overflow-hidden">
        ...
        <div className="flex flex-col gap-2">
          ...
          <button
              ...
              className="w-full px-3 py-2 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800"
            >
              Ver Detalles
          </button>
